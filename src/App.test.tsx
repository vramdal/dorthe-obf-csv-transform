...
const expectedOutputFileContents = `KORT;KORT EID AV KUNDE;PRIS BOOKING;MEDLEM;KUNDEID;RESSURS;BESØKSDATO;STARTTID;BESTILLINGSDATO;BESTILLINGSTID;ANTALLRESURSER
<br/>;;NOK 200;yes;5964973;Dropin  - Sukkerbiten;01.05.2022;07:00-08:30;19.04.2022;19.04.2022 12:04;2
...
/*
  await waitFor(() => {
    expect(within(screen.getByTestId("region-Fjern alle ,00")).getByRole("textbox")).not.toHaveValue("");
  })
*/
  ...
  const outputTextArea = within(screen.getByTestId("region-Last ned behandlet CSV-fil")).getByRole("textbox");
  await waitFor(() => {
    expect(outputTextArea).toHaveValue(expectedOutputFileContents);
  })
